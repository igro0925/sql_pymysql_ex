...
insert into users_info
(id, username, email, phone, website, regdate)
values (3, 'park', 'park@cozlab.com', '010-1234-5678', 'cozlab.com', '2020-10-24 00:00:00');

insert into users_info
(id, username, email, phone, website, regdate)
values (4, 'yang', 'yang@cozlab.com', '010-1234-5678', 'cozlab.com', '2020-10-24 00:00:00');

insert into users_info
(id, username, email, phone, website, regdate)
values (5, 'yang', 'yang@cozlab.com', '010-1234-5678', 'cozlab.com', '2020-10-24 00:00:00');

-- DML -Read(데이터 읽기)
-- users_-info 테이블의 모든 데이터 읽기
select *
from users_info;

-- DML - 특정 걸럼 데이터 읽기
select username, phone
from users_info as ui -- as는 생략 가능하다
